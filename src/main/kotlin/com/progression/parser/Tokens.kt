package com.progression.parser

import com.progression.parser.expression.*
import com.progression.parser.expression.ExpressionConstants.Companion.e
...
import com.progression.parser.expression.Function
import com.progression.parsertokenizer.Atomic
import java.util.*
...
private class TokenNode private constructor(val token: Token, val children: List<TokenNode> = listOf()) :
    com.progression.parser.Operators {
...
enum class BracketsType(private val pattern: String) : SubPattern, com.progression.parser.Operators {
...
enum class OperatorType(private val pattern: String, private val priority: Priority) : SubPattern, com.progression.parser.Operators, Nodable {
    add("\\+", Priority.low),
